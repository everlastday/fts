            ...
            <?php
             $menu = [
                 'products' => [
                     'title' => 'Товари',
                     'items' => [
                         'product-info' => 'Менеджер товарів',
                         'product-categories' => 'Категорія Товарів',
                         'page' => 'Менеджер сторінок',
                     ]
                 ],
                 'users' => [
                     'title' => 'Користувачі',
                ...
                <div class="menu-wrapper">
                    ...
                    foreach ($menu as $container) {
                        ...
                        foreach($container['items'] as $link => $url_name) {
                            ...
                            echo '<li' . $active . '><a href="' . Yii::$app->request->getBaseUrl() . '/'. $link .  '">' . $url_name .'</a></li>';
                        }
                        echo '</ul></div>';

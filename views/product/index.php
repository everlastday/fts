...
<div class="products-description-cart">
  ...
  <div style="max-width: 17em;">
	  <?php if ( ! empty( $gallery[ 'url' ] ) ): ?>
        <a class="btn-grey" href="<?=Url::toRoute( [ 'gallery/index', 'id' => $gallery[ 'url' ] ] );?>">Взірці
          кольорів</a>
	  <?php endif ?>
  </div>
      ...
      <div class="also-buy">
        ...
        <div class="container">
          <div class="also-buy-item">
            ...
            <p class="description">
              <strong>Штукатурка STRUCTURE LINE</strong></br> Акрилова декоративна штукатурка використовується для
              зовнішніх та внутрішніх робіт.</p>
          ...
          <div class="also-buy-item">
            ...
            <p><strong>Штукатурка STONE LINE DECOR</strong> </br> Мозаїчна декоративна штукатурка використовується для
              зовнішніх та внутрішніх робіт.</p>
          </div>
          <div class="clearfix"></div>
        </div>
